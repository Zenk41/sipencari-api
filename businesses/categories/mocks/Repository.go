...
func (_m *Repository) Delete(category_id string) bool {
...
func (_m *Repository) GetByID(category_id string) categories.Domain {
	ret := _m.Called(category_id)
...
func (_m *Repository) Update(category_id string, categoryDomain *categories.Domain) categories.Domain {
