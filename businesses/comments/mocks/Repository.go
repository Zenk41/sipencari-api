...
func (_m *Repository) Create(idUser string, idPost string, commentDomain *comments.Domain) comments.Domain {
...
func (_m *Repository) Delete(idPost string, idComment string) bool {
...
func (_m *Repository) GetAll(idPost string) []comments.Domain {
...
func (_m *Repository) GetByID(idPost string, id string) comments.Domain {
...
func (_m *Repository) Update(idUser string, idPost string, idComment string, commentDomain *comments.Domain) comments.Domain {
